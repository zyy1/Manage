...
<body class="well">
<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath }/CarAction_updateCar">
  ...
  <table  class="table table-striped table-bordered" align="center" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#f0f8ff">
    <tr>
      <td colspan="4" align="center" class="table-title" valign="center"><h4>编辑车辆信息<br />
      </h4></td>
    </tr>
    <tr>
      <td width="50%">
