...
<body class="well">
<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath }/PersonAction_addPerson">
  ...
  <table  class="table table-striped table-bordered" align="center" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#f0f8ff">
    <tr>
      <td colspan="4" align="center" class="table-title" valign="center"><h4>添加人口信息<br />
      </h4></td>
    </tr>
    <tr>
      <td width="50%">
    ...
    <tr>
      ...
      <input type="text" name="birthday" onfocus="WdatePicker()" value="${birthday }" class="form-control"/>
      </div>
      </td>
    </tr>
    <tr>
