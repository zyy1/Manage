...
<body class="well">
	<form id="form1" name="form1" method="post"
		action="${pageContext.request.contextPath }/CaseinfoAction_updateCaseinfo">
		...
		<table class="table table-striped table-bordered">
			...
			<tr>
				...
				<div class="input-group-addon">摘　　要</div>
					<input type="text" name="smallContent" class="form-control" style="margin-bottom:5px;" value="${smallContent }"/>
				</div>
				<div class="input-group has-feedback">
