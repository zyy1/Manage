...
<body class="well">
	<form id="form1" name="form1" class="form-inline" method="post"
		action="${pageContext.request.contextPath }/UserAction_addUser">
			...
			<tr>
				<td>
					<div class="input-group has-feedback">
						...
						<input type="text" name="email" class="form-control" placeholder="该项不允许为空！" />
					</div>
				</td>
				<td>
					<div class="input-group has-feedback">
						<div class="input-group-addon">电　话</div>
						<input type="text" name="phone" class="form-control" placeholder="该项不允许为空！" />
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div class="input-group has-feedback">
						...
						<input type="text" name="idCard" class="form-control" placeholder="该项不允许为空！" />
					</div>
				</td>
				<td>
					<div class="input-group has-feedback">
						<div class="input-group-addon">角　色</div>
						<input type="text" name="work" class="form-control" placeholder="该项不允许为空！" />
					</div>
			...
			<tr>
				<td>
					<div class="input-group has-feedback">
						...
						<input type="text" name="wordCard" class="form-control" placeholder="该项不允许为空！" />
					</div>
				</td>
			</tr>
			<tr>
