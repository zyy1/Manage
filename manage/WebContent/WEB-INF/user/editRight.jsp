...
<body class="well">
	<form id="form1" name="form1" class="form-inline" method="post"
		action="${pageContext.request.contextPath }/UserAction_updateRight">
		<input type="hidden" name="rightId" value="${right.id }" />
		<input type="hidden" name="right.rightUrl" value="${right.rightUrl }" />
		<table class="table table-striped table-bordered" align="center"
			...
			<tr>
				<td>
					<div class="input-group has-feedback">
						<div class="input-group-addon">公共资源</div>
						<select name="right.common" class="form-control">
							<option value="true" <s:if test="right.common == true">selected</s:if>>是</option>
							<option value="false" <s:if test="right.common == false">selected</s:if>>否</option>
						</select>
					</div>
				</td>
			</tr>
