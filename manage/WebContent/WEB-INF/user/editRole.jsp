...
<body class="well">
	<form id="form1" name="form1" class="form-inline" method="post"
		action="${pageContext.request.contextPath }/UserAction_updateRole">
			...
			<td>
					<div class="input-group has-feedback">
						...
						<select class="form-control" name="roleValue">
							<option value="-1" <s:if test='role.roleValue == -1'>selected</s:if>>是</option>
							<option value="0" <s:if test='role.roleValue != -1'>selected</s:if>>否</option>
						</select>
					</div>
			</td>
			</tr>
