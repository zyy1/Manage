...
<body class="well">
	<form id="form1" name="form1"  method="post"
		action="${pageContext.request.contextPath }/ShopAction_addShop">
			...
			<tr>
				<td width="50%">
					<div class="input-group has-feedback">
						<div class="input-group-addon">商　　号</div>
				...
				<td width="50%">
					<div class="input-group has-feedback">
						<div class="input-group-addon">单　　元</div>
			...
			<tr>
				...
				<td>
					<div class="input-group has-feedback">
						...
						<input type="text" name="room" class="form-control" placeholder="该项不允许为空！" />
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div class="input-group has-feedback">
						...
						<input type="text" name="shopName" class="form-control" placeholder="该项不允许为空！" />
					</div>
				</td>
				<td>
					<div class="input-group has-feedback">
						<div class="input-group-addon">店　　主</div>
						<input type="text" name="bossName" class="form-control" placeholder="该项不允许为空！" />
					</div>
			...
			<tr>
				<td>
					<div class="input-group has-feedback">
						...
						<input type="text" name="shopType" class="form-control" placeholder="该项不允许为空！" />
					</div>
				</td>
				<td>
					<div class="input-group has-feedback">
						<div class="input-group-addon">店主身份证</div>
						<input type="text" name="bossIdCard" class="form-control" placeholder="该项不允许为空！" />
					</div>
				</td>
			</tr>
			<tr>
